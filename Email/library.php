...
define("SMTP_UNAME", "hoangtrungquan2001@gmail.com"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PASSWORD", "umzertnwntfuuqrb"); //Password for SMTP authentication
